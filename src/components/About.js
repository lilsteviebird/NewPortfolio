      ...
      <div className="container mx-auto flex px-10 py-20 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <p className="mb-8 leading-relaxed">
            ...
            Although young (I just turned 23... yikes), I've been fortunate to have had several professional experiences in prominent organizations within the software industry. Although my skills lie towards the back-end side of things, I've been learning front-end work
